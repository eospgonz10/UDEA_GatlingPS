...
object Data{
    ...
    val loginNormalDuration: FiniteDuration = 2.minutes
    val loginPeakDuration: FiniteDuration = 2.minutes
    val loginP95NormalMs = 2000
    val loginP95PeakMs = 5000

    // Historia 2: Transferencias simultaneas
    val transferStressDuration: FiniteDuration = 3.minutes
    val transferRampUpDuration: FiniteDuration = 1.minute
    val transferTargetTps = 150

    // Historia 3: Estado de cuenta
    val statementAccountId = fromAccountId
    val statementUsers = 200
    val statementDuration: FiniteDuration = 3.minutes
